...
public class Tour implements Serializable {
    ...
    private Collection<ScheduledTour> scheduledTourCollection;
    ...
    @XmlTransient
    public Collection<ScheduledTour> getScheduledTourCollection() {
        return scheduledTourCollection;
    }

    public void setScheduledTourCollection(Collection<ScheduledTour> scheduledTourCollection) {
        this.scheduledTourCollection = scheduledTourCollection;
    }
